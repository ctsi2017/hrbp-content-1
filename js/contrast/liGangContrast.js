...
//tab切换
    ...
    function changeStyle() {
        ...
        $(".ch_columar_title,.columar-area-point").css("display", "none");
...
//多维度添加确定
    ...
    $(".btnOk").click(function () {
        ...
        jsonData();
        empLiGangContrast(sites, post, time, type);
        // $("#columar-area").css("display", "block");
        createTitle(multiData, currentSingleSelectLeft, currentSingleSelectRight,sites);
    });
